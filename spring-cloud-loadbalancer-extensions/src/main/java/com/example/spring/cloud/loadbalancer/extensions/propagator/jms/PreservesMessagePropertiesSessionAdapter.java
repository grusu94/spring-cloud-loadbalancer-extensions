...
/**
 * Session adapter that preserves the {@link ExecutionContext} by copying message propagationProperties
 * from/to the current {@link ExecutionContext} entry pre-filtering property names or entry keys using the provided.
 */
@Slf4j
public class PreservesMessagePropertiesSessionAdapter extends AbstractExecutionContextCopy<Message>
     ...
     * @return the message
     */
    private <T extends Message> T copyExecutionContextToMessageProperties(T message) {
    ...
    public void setMessageListener(MessageListener listener) throws JMSException {
        delegate.setMessageListener(listener instanceof PreservesMessagePropertiesMessageListener ?
                listener : new PreservesMessagePropertiesMessageListener(listener, getFilter(), encoder));
    }
    ...
    public MessageProducer createProducer(Destination destination) throws JMSException {
        return new PreservesMessagePropertiesMessageProducerAdapter(
                delegate.createProducer(destination), getFilter(), getExtraStaticEntries(), encoder);
    }
    ...
    public MessageConsumer createConsumer(Destination destination) throws JMSException {
        return new PreservesMessagePropertiesMessageConsumerAdapter(
                delegate.createConsumer(destination), getFilter(), encoder);
    }
    ...
    public MessageConsumer createConsumer(Destination destination, String messageSelector) throws JMSException {
        return new PreservesMessagePropertiesMessageConsumerAdapter(
                delegate.createConsumer(destination, messageSelector), getFilter(), encoder);
    }
    ...
    public MessageConsumer createConsumer(Destination destination, String messageSelector, boolean noLocal) throws JMSException {
        return new PreservesMessagePropertiesMessageConsumerAdapter(
                delegate.createConsumer(destination, messageSelector, noLocal), getFilter(), encoder);
    }
    ...
    public MessageConsumer createSharedConsumer(Topic topic, String sharedSubscriptionName) throws JMSException {
        return new PreservesMessagePropertiesMessageConsumerAdapter(
                delegate.createSharedConsumer(topic, sharedSubscriptionName), getFilter(), encoder);
    }
    ...
    public MessageConsumer createSharedConsumer(Topic topic, String sharedSubscriptionName, String messageSelector)
            throws JMSException {
        return new PreservesMessagePropertiesMessageConsumerAdapter(
                delegate.createSharedConsumer(topic, sharedSubscriptionName, messageSelector), getFilter(), encoder);
    }

    @Override
    public MessageConsumer createDurableConsumer(Topic topic, String name) throws JMSException {
        return new PreservesMessagePropertiesMessageConsumerAdapter(
                delegate.createDurableConsumer(topic, name), getFilter(), encoder);
    }
    ...
    public MessageConsumer createDurableConsumer(Topic topic, String name, String messageSelector, boolean noLocal)
            throws JMSException {
        return new PreservesMessagePropertiesMessageConsumerAdapter(
                delegate.createDurableConsumer(topic, name, messageSelector, noLocal), getFilter(), encoder);
    }

    @Override
    public MessageConsumer createSharedDurableConsumer(Topic topic, String name) throws JMSException {
        return new PreservesMessagePropertiesMessageConsumerAdapter(
                delegate.createSharedDurableConsumer(topic, name), getFilter(), encoder);
    }
    ...
    public MessageConsumer createSharedDurableConsumer(Topic topic, String name, String messageSelector)
            throws JMSException {
        return new PreservesMessagePropertiesMessageConsumerAdapter(
                delegate.createSharedDurableConsumer(topic, name, messageSelector), getFilter(), encoder);
    }
}
